...
/**
 * Filtrer l'arbre et retourner les données sous forme de liste
 * @param treeData
 * @param key Champ utilisé pour le filtrage
 * @param value Valeur utilisée pour le filtrage
 */
...
/**
 * Filtrer l'arbre en conservant la structure d'origine
 * @param treeData
 * @param predicate
 */
